...
import 'package:myapp/view/beneficios/backend/beneficios_get_provider.dart';
import 'package:provider/provider.dart';

class AddBeneficiosScreen extends StatefulWidget {
  const AddBeneficiosScreen._();
  static Widget init() => ChangeNotifierProvider(
        create: (context) => BeneficiosProvider(
            beneficiosRepo: context.read<BeneficiosRepository>()),
        child: const AddBeneficiosScreen._(),
      );

  @override
  State<AddBeneficiosScreen> createState() => _AddBeneficiosScreenState();
}

List<String> tipoBeneficio = ['ORO', 'PLATA', 'COBRE'];

class _AddBeneficiosScreenState extends State<AddBeneficiosScreen> {
        ...
        body: ListView(children: [
          ...
          Padding(
            ...
            child: TextButton.icon(
                onPressed: () {
                  context.read<BeneficiosProvider>().add(Beneficios(
                      tipo: selectedTipo,
