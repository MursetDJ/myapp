...
import 'package:myapp/view/register/REGISTER/upload_files.dart';
import 'package:myapp/view/register/register_header.dart';
import 'package:myapp/view/registrados/register_add_provider.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      validarsesion = await Auth().inSession();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    if (validarsesion != null) {
      ...
      return Center(
        ...
        child: const Text(
          "NO TIENEN PERMISOS NECESARIOS PARA ACCEDER A ESTE MENÚ",
